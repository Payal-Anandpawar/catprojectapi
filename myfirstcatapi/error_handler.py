...
import myfirstcatapi.exceptions
...
async def exception_handler(request: Optional[Request], exc: Exception) -> JSONResponse:
    exception_to_http_error_mapping: Mapping[Type[Exception], int] = {
        myfirstcatapi.exceptions.EntityNotFoundError: status.HTTP_404_NOT_FOUND,
        myfirstcatapi.exceptions.DuplicateEntityError: status.HTTP_409_CONFLICT,
    }
