...
from myfirstcatapi import config
from myfirstcatapi.error_handler import exception_handler, validation_exception_handler
from myfirstcatapi.events.event_handlers import EVENT_HANDLERS
from myfirstcatapi.exceptions import MyfirstcatapiError
from myfirstcatapi.libs import log_sanitizer
from myfirstcatapi.views import cat_view, status_view
...
def add_exception_handlers(app: FastAPI) -> None:
    ...
    app.add_exception_handler(MyfirstcatapiError, exception_handler)
...
app = FastAPI(
    title="Myfirstcatapi",
    description="Lionbridge AI Cat Management Service",
