...
from myfirstcatapi.main import app
...
@mock.patch("myfirstcatapi.domains.cat_domain.create_cat")
...
@mock.patch("myfirstcatapi.domains.cat_domain.find_one")
def test_get_cat(
...
@mock.patch("myfirstcatapi.domains.cat_domain.find_many")
def test_list_cats(
